...
This repository contains the source code and resources for the Bachelor's Thesis "Automated Segmentation of Amyloid Fibres from Electron Micrographs." The thesis focuses on developing and evaluating deep learning models for the instance segmentation of amyloid fibres, particularly in conditions with high-density clustering and noise.

This work includes a custom framework for generating synthetic electron microscopy images, along with pipelines for training and evaluating models like YOLOv11 and the Segment Anything Model (SAM).
...
4. Download datasets and models (Optional)
