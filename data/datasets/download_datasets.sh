...
$CMD $ZIP_FILE_YOLO || { echo "Failed to download dataset from $sam2p1_hiera_t_url"; exit 1; }

echo "Downloading SAM dataset..."
$CMD $ZIP_FILE_SAM || { echo "Failed to download dataset from $sam2p1_hiera_t_url"; exit 1; }
